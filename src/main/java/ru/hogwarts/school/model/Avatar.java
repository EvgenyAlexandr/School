...
public class Avatar {
    ...
    private String  filePath;       // Путь к файлу Аватар
    private String  mediaType;      // Тип Аватар файла
    private long    fileSize;       // Размер Аватар файла

    @Lob
    private byte[] data;            // Массив байт для хранения превью Аватар

    @OneToOne                       // Связь таблиц в базе. Для привязки Аватар к нужному студенту
